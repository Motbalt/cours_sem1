...
public class De {
	...
	protected String nomDe;  //je préfère dédé que dé
	private static int nbDe = 0;
	protected static Random r = new Random();	

	public De() {
		this.nomDe = "dé n°"+nbDe;
		nbDe++;
	}
	...
	public String toSring() {
		return "Le nom du dé est : " + nomDe + " Et il comporte : " +  nbFaces;
	}
	...
	public String getLancePipe(int minimum) {
		...
		String lance="Vous avez fait un " + nbAleatoire;		n'existe plus
		return lance;		
	}
